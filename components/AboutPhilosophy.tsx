...
export default function AboutPhilosophy() {
  return (
    <section id="about" className="relative py-24 bg-transparent text-white px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
        <div className="order-2 md:order-1 space-y-8">
          <div className="space-y-2">
            <h3 className="text-crimson text-lg font-bold tracking-widest uppercase">Philosophy</h3>
            <h2 className="text-4xl md:text-5xl font-serif font-bold leading-tight italic text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-100 to-white/60">
              &quot;Every Story Leaves Something Behind.&quot;
            </h2>
          </div>
          <p className="text-gray-400 leading-relaxed text-lg">
            After Eternity was founded on the belief that films should endure beyond their final frame. We partner with
            filmmakers to shape stories through editing, color grading, and creating images that remain emotionally
            resonant long after the credits roll.
          </p>
          <p className="text-gray-400 leading-relaxed text-lg">
            I like to take my time with every project until it feels complete. Whether that means traveling farther to
            capture the right footage or spending extra hours refining a single scene in post-production, If a story
            needs another day of filming, another revision, or another evening in the grading suite, that&apos;s time
            well spent.
          </p>
          <p className="text-gray-400 leading-relaxed text-lg">
        ...
        <div className="order-1 md:order-2 flex flex-col items-center justify-center relative group min-h-[400px]">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center">{PHILOSOPHY_LOGO_PATHS}</div>
